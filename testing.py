...
plt.figure()
plt.semilogx(PIXIE_freqs/1.e9, dust, label='dust')
plt.savefig('dust')

plt.figure()
plt.semilogx(PIXIE_freqs/1.e9, synch, label='synch')
plt.savefig('synch')

plt.figure()
plt.semilogx(PIXIE_freqs/1.e9, brem, label='free free')
plt.savefig('brem')

plt.figure()
plt.semilogx(PIXIE_freqs/1.e9, spinning, label='ame')
plt.savefig('ame')
