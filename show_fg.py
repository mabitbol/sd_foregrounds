...
def plot_foregrounds():
    ...
    PIXIE_freq_max = 6.0225e12 #central frequency of highest channel (chose this to get 400 total channels)
    plt.figure()
    plt.loglog(PIXIE_freqs/1.e9, 1.0e26*dust, label='dust')
    plt.loglog(PIXIE_freqs/1.e9, 1.0e26*synch, label='synch')
    plt.loglog(PIXIE_freqs/1.e9, 1.0e26*brem, label='free free')
    plt.loglog(PIXIE_freqs/1.e9, 1.0e26*spinning, label='ame')
